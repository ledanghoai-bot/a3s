...
- **Migration manifest/checksum:** `001`–`028`; rehearsal ghi 28 rows / 28 distinct checksums
  (`m2_existing_apply_rehearsal`). Migrations expand-only, forward, postcondition fail-closed.
