...
async def main() -> int:
    ...
    p.add_argument("--id", type=int, required=True, help="immutable staff id (BAT BUOC — doi chieu identity)")
    p.add_argument("--actor", required=True, help="operator (username account active, KHAC target)")
    ...
    p.add_argument("--prior-role-key", default=None,
                   help="PHAI de trong — restore chi ve NULL; gia tri khac se bi tu choi (chong escalation)")
