...
ALLOWED_TRANSITIONS = {
    ...
    # (khong de intent "ket" o READY/ADDRESS_CHECK/NEEDS_CLARIFICATION voi draft khong du dieu kien).
    "COLLECTING": {"ADDRESS_CHECK", "CANCELLED", "ESCALATED", "EXPIRED"},
    "ADDRESS_CHECK": {"COLLECTING", "NEEDS_CLARIFICATION", "READY_TO_COMMIT",
                      "CANCELLED", "ESCALATED", "EXPIRED"},
    "NEEDS_CLARIFICATION": {"COLLECTING", "ADDRESS_CHECK", "CANCELLED", "ESCALATED", "EXPIRED"},
    "READY_TO_COMMIT": {"COLLECTING", "COMMITTING", "ADDRESS_CHECK", "CANCELLED", "ESCALATED", "EXPIRED"},
